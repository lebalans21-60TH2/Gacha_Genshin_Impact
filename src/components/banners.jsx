...
export default class Banners extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      banners: {
        'beginners-wish': 'Cầu nguyện tân thủ',
        [selectedCharacterEventWish]: 'Cầu nguyện nhân vật',
        'epitome-invocation': 'Cầu nguyện vũ khí',
        'wanderlust-invocation': 'Cầu nguyện thường'
      },
      wishes: {
    ...
    if(newSelectedCharacterEventWish !== selectedCharacterEventWish) {
      ...
      for(const b in oldBanners) {
        if(selectedCharacterEventWish === b) {
          banners[newSelectedCharacterEventWish] = 'Cầu nguyện nhân vật'
        } else {
  ...
  toggleBeginnersWish(isLimited) {
    if (isLimited) {
      this.setState({
        ...
        banners: {
          [this.props.getFormattedCharacterEventWish('kebabCase')]: 'Cầu nguyện nhân vật',
          'epitome-invocation': 'Cầu nguyện vũ khí',
          'wanderlust-invocation': 'Cầu nguyện thường'
        },
        wishes: {
